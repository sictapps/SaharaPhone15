            ...
            class extends OrderWidget {
                ...
                async _editPackLotLines(event) {
                    ...
                    if (confirmed) {
                        ...
                        const orderlineToRefund = this.env.pos.toRefundLines[Object.keys(this.env.pos.toRefundLines)[0]].orderline;
                        ...
                        for (let i = 0; i < lines.length; i++) {
                            ...
                            originalOrderline = lot_id.find(lot => {
                                return lot.product_id[0] === orderline.product.id &&
                                    newPackLotLines[0] && lot.lot_name === newPackLotLines[0].lot_name;
                            });
